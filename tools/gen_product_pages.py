...
MODELS = {  # code: (series, jp, copy, asset folder)
 ...
 'SW80':('BAG','防水ダッフルバッグ','80Lの完全防水ダッフル。ロールトップで荷室を守る。','00 - NEW PRODUCTS/01_SW80'),
 ...
 'SL18':('BAG','SLバッグ','新世代ソフトラゲッジ。','00 - NEW PRODUCTS/00_SL Bags'),
...
CAPS={'TR41':'41L','TR46':'46L','TR48':'48L','TR55':'55L','TR37':'37L','TR47':'47L','TR36':'36L','TR27':'27L',
 ...
 'SH23':'23L','SW80':'80L','TR50':'50L','TR40':'40L','TR30':'30L','TR10':'10L','E48':'48L','SL18':None,'LOCK':None,'SEAT':None}
NEW={'TR46','TR27','SH51','SW80','SL18'}
...
FEAT={
 ...
 'SW80':[('box','容量','80L'),('droplet','完全防水',None),('shield','ロールトップ',None)],
 ...
 'SL18':[('droplet','防水',None),('shield','軽量ソフト',None),('click','クリックシステム',None)],
...
DESC={
 ...
 'SW80':'80L容量の完全防水バッグ（IPX5）。長距離ツーリングの荷物運搬に応えます。コンプレッションストラップと空気排出バルブで容積を抑え、運搬時の安定性と快適性を向上。パッド付きショルダーでバックパックとしても背負えます。',
...
OVERRIDE={
 ...
 'SW80':'00 - NEW PRODUCTS/01_SW80/Photos/*.jpg',
 ...
 'SL18':'00 - NEW PRODUCTS/00_SL Bags/Photos/SL04/*.jpg',
}
def _num(fn):
