...
(function () {
  ...
  function build(){
    ...
    input.addEventListener('keydown', function(e){
      ...
      else if (e.key === 'Enter') { e.preventDefault(); var a = list.querySelectorAll('.srch-item')[Math.max(active,0)]; if (a) location.href = a.getAttribute('href'); else if (input.value.trim()) location.href = '/shad/products'; }
    });
  ...
  function load(){
    ...
    return fetch('/shad/data/catalog/cards.json').then(function(r){ return r.ok ? r.json() : {}; }).then(function(d){
